...
public class ItsDaTest{
	...
	public void testReg() throws InterruptedException{
		...
		WebElement check = driver.findElement(By.xpath("//*[@id=\"name_3_firstname\"]"));
		if (check.getText().equals("Joan")) {
			test.log(LogStatus.PASS, "Details inputted from spreadsheet");
		}
		else {
			test.log(LogStatus.FAIL, "Details not inputted");
		}
		assertEquals("Joan", check.getText());
	}
